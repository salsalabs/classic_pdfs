...
def main():
	pageSpecs = [
		...
		Spec(**{
			...
			'table': "content_item",
			'titleField': "Reference_Name",
			'keyField': "content_item_KEY",
			'dateField': "Date_Created"
		}),
		Spec(**{
			'url': "https://{host}/o/{organization_KEY}/p/salsa/donation/common/public/?donate_page_KEY={key}",
			'table': "donate_page",
			'titleField': "Reference_Name",
			'keyField': "donate_page_KEY",
			'dateField': "Date_Created"
		}),
		Spec(**{
		...
		Spec(**{
			'url': "http://{host}/o/{organization_KEY}/p/salsa/web/common/public/signup?signup_page_KEY={key}",
			'table': "signup_page",
			'titleField': "Reference_Name",
			'keyField': "signup_page_KEY",
			'dateField': "Date_Created"
		}),
		Spec(**{
			'url': "https://{host}/o/{organization_KEY}/t/0/shop/shop.jsp?storefront_KEY={key}",
			'table': "storefront",
			'titleField': "Reference_Name",
			'keyField': "storefront_KEY",
			'dateField': "Date_Created"
		}),
		Spec(**{
			'url': "http://{host}/o/{organization_KEY}/p/salsa/supporter/unsubscribe/public/index.sjs?unsubscribe_page_KEY={key}",
